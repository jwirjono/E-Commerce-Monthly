<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tambahproduk.aspx.cs" Inherits="PIGMA.tambahproduk" %>
            ...
            <div class="row col-md-12" style="border: solid thin; border-radius: 10px; height: 350px">
                ...
                <div class="col-md-12">
                    ...
                    <label style="margin-top: 10px; margin-left: 110px;">
                        <asp:TextBox runat="server" Style="border-radius: 10px; height: 40px;" type="text" ID="namaproduk" size="60" /></label><br />
                </div>
                <div class="col-md-12">
                    ...
                    <label style="margin-top: 5px; margin-left: 55px;">
                        <asp:TextBox runat="server" Style="border-radius: 10px; height: 40px;" type="text" ID="deskripsi" size="60" /></label><br />
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <label style="margin-top: 10px; margin-left: 155px; height: 40px;">
                        <asp:DropDownList id="kategori"
                            AutoPostBack="True"
                            runat="server" style="border-radius: 10px; width: 450px; text-align: center; height: 40px;">

                            <asp:ListItem value="0">Pilih Kategori</asp:ListItem>
                            <asp:ListItem value="1">Daging dan Seafood</asp:ListItem>
                            <asp:ListItem value="2">Keperluan Dapur</asp:ListItem>
                            <asp:ListItem value="3">Minuman</asp:ListItem>
                            <asp:ListItem value="4">Makanan Ringan</asp:ListItem>
                            <asp:ListItem value="5">Produk Beku</asp:ListItem>
                            <asp:ListItem value="6">Perlengkapan Bayi</asp:ListItem>
                            <asp:ListItem value="7">Produk Roti</asp:ListItem>
                            <asp:ListItem value="8">Korean Food</asp:ListItem>
                            <asp:ListItem value="9">Perlengkapan Hewan</asp:ListItem>
                            <asp:ListItem value="10">Produk Kesehatan</asp:ListItem>
                            <asp:ListItem value="11">Produk Kecantikan</asp:ListItem>
            ...
            <div class="row col-md-12" style="border: solid thin; border-radius: 10px; height: 250px">
                ...
                <div class="col-md-12">
                    ...
                    <label style="margin-top: 10px; margin-left: 90px;">
                        <asp:textbox runat="server" style="border-radius: 10px; height: 40px;" type="number" id="maxpemesanan" size="60" min="1" max="100" step="1" /></label><br />
                </div>
                <div class="col-md-12">
                    <label style="margin-top: 10px; margin-left: 70px; font-size: 18px;">
                        <b>Harga Satuan</b>
                    ...
                    <label style="margin-top: 10px; margin-left: 110px;">
                        Rp
                        <asp:textbox runat="server" style="border-radius: 10px; height: 40px;" type="number" id="hargasatuan" min="1000" max="100000000" step="1000" /></label><br />
                </div>
            </div>
            <hr style="width: 100%; text-align: left; margin-left: 50px; margin-right: 50px; border-width: 1.5px;">
            <div class="row col-md-12" style="border: solid thin; border-radius: 10px; height: 350px">
                ...
                <div class="col-md-12">
                    ...
                    <asp:textbox runat="server" style="border-radius: 10px; height: 40px; margin-left: 110px; max-width: 150px" type="number" id="stokproduk"/>
                </div>
            </div>
        </div>
