<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kembalikan.aspx.cs" Inherits="PIGMA.Kembalikan" %>
...
<body>
    ...
    <div class="container-fluid row">
        ...
        <!--content-->
        <form class="col-md-8" runat="server" style="padding-top:20px">
            <a href="adminpesanan.aspx" style="color: #74B816; font-size: 18px; padding-top:20px">< Kembali</a>
            ...
            <asp:Panel class="col-md-12" ID="panelPembelianBelanja" runat="server" Visible="true" Style="margin-top: 40px">
                <asp:Panel ID="panel1" runat="server">
                    <div class="col-md-12" style="margin-top: 20px; margin-bottom: 20px">
                        <img src="AdminContent/labelpemesanandlmpengiriman.png" />
                    </div>
                    ...
                    <div class="col-md-12" style="text-align: right; margin-top: 50px; margin-bottom: 50px">
                        <asp:Button runat="server" class="masukLoginPlus" OnClick="btnubah_Click" Text="Kembalikan Produk" />
                        <asp:Button runat="server" class="masukLoginPlus" OnClick="btnkirim_Click" Text="Selesai" />
                    </div>
                </asp:Panel>
