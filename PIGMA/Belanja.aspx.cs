    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void btnComplete_Click(object sender, EventArgs e)
        {
            if (Session["Supermarket"].ToString() == "Lotte Mart")
            {
                ...
                data.DataBelanjaSet(2, "Shabu Shabu", int.Parse(lblItemCard1.Text), 30000);
                data.DataBelanjaSet(1, "Beef Yakiniku", int.Parse(lblItemCard2.Text), 25000);
                data.DataBelanjaSet(3, "Beef Bulgogi", int.Parse(lblItemCard3.Text), 35000);
                data.DataBelanjaSet(4, "Salmon Fillet", int.Parse(lblItemCard4.Text), 50000);
